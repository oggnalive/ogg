...
#ifndef OGGNALIVE_SCRIPT_SCRIPT_H
#define OGGNALIVE_SCRIPT_SCRIPT_H
...
public:
    ...
    /**
     * Pre-version-0.6, oggnalive always counted CHECKMULTISIGs
...
#endif // OGGNALIVE_SCRIPT_SCRIPT_H
