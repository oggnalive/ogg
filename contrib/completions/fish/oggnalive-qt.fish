...
complete --command oggnalive-qt --no-files

# Extract options
function __fish_oggnaliveqt_get_options
...
complete \
    --command oggnalive-qt \
    --arguments "(__fish_oggnaliveqt_get_options)"
# Enable file completions only if the commandline now contains a `*.=` style option
complete -c oggnalive-qt \
...
complete \
    --command oggnalive-qt \
    --arguments "(__fish_oggnaliveqt_get_options --nofiles)"
