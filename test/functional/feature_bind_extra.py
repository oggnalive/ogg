...
"""
Test starting oggnalived with -bind and/or -bind=...=onion and confirm
...
class BindExtraTest(oggnaliveTestFramework):
    ...
    def run_test(self):
        for i in range(len(self.expected)):
            ...
            # that oggnalived has bound on "::1" (for RPC) and "::" (for P2P).
