Download URL: https://sourceforge.net/projects/oggnalive/files/oggnalive/oggnalive-0.3.22/
...
Notable changes:
* Client will accept and relay TX's with 0.0005 OGG fee schedule (users still pay 0.01 OGG per kb, until next version)
...
* IRC is overflowing.  Client now bootstraps to channels #oggnalive00 - #oggnalive99
