oggnalive Core version 0.13.2 is now available from:

  <https://oggnalive.org/bin/oggnalive-core-0.13.2/>
...
- #8908 `4a974b2` Update oggnalive-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow oggnalive-tx to create v2 transactions (oggdrak)
