...
#ifndef OGGNALIVE_WALLET_TRANSACTION_H
#define OGGNALIVE_WALLET_TRANSACTION_H
...
public:
     ...
     * on this oggnalive node, and set to 0 for transactions that were created
...
#endif // OGGNALIVE_WALLET_TRANSACTION_H
