...
#ifndef OGGNALIVE_QT_GUIUTIL_H
#define OGGNALIVE_QT_GUIUTIL_H
...
/** Utility functions used by the oggnalive Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "oggnalive:" URI into recipient object, return true on successful parsing
