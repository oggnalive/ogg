...
complete --command oggnalived --no-files

# Extract options
function __fish_oggnalived_get_options
...
complete \
    --command oggnalived \
    --arguments "(__fish_oggnalived_get_options --nofiles)"
