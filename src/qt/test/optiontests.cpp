...
{
    // Test regression https://github.com/oggnalive/oggnalive/issues/24457. Ensure
...
{
    // Test that the bug https://github.com/oggnalive-core/gui/issues/567 does not resurface.
    // It was fixed via https://github.com/oggnalive-core/gui/pull/568.
    // With fListen=false in ~/.config/oggnalive/oggnalive-Qt.conf and all else left as default,
    // oggnalive-qt should set both -listen and -listenonion to false and start successfully.
