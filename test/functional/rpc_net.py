...
class NetTest(oggnaliveTestFramework):
    ...
    def test_getnodeaddresses(self):
        ...
        self.nodes[0].addpeeraddress(address=ipv6_addr, port=13370)
        ...
        for i in range(10000):
            ...
            self.nodes[0].addpeeraddress(a, 13370)
    ...
    def test_addpeeraddress(self):
        ...
        assert_equal(node.addpeeraddress(address="", port=13370), {"success": False})
