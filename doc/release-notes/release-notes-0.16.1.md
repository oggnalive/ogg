oggnalive Core version 0.16.1 is now available from:

  <https://bitcoincore.org/bin/oggnalive-core-0.16.1/>
...
- #12843 `df38b13` Test starting oggnalived with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure oggnalived processes are cleaned up when tests end (sdaftuar)
