...
# Extract options
function __fish_oggnalive_tx_get_options
...
# Extract commands
function __fish_oggnalive_tx_get_commands
...
# Add options
complete \
    --command oggnalive-tx \
    --condition "not __fish_oggnalive_seen_cmd (__fish_oggnalive_tx_get_commands --commandsonly)" \
    --arguments "(__fish_oggnalive_tx_get_options)" \
    --no-files

# Add commands
complete \
    --command oggnalive-tx \
    --arguments "(__fish_oggnalive_tx_get_commands)" \
    --no-files
