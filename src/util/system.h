 ...
 */
#ifndef OGGNALIVE_UTIL_SYSTEM_H
#define OGGNALIVE_UTIL_SYSTEM_H
...
extern const char * const OGGNALIVE_CONF_FILENAME;
extern const char * const OGGNALIVE_SETTINGS_FILENAME;
