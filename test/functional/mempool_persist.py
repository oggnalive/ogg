...
By default, oggnalived will dump mempool on shutdown and
...
class MempoolPersistTest(oggnaliveTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent oggnalived from writing mempool.dat to disk. Verify that `savemempool` fails")
