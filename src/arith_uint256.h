...
#ifndef OGGNALIVE_ARITH_UINT256_H
#define OGGNALIVE_ARITH_UINT256_H
...
public:
     ...
     *
     * oggnalive only uses this "compact" format for encoding difficulty
...
#endif // OGGNALIVE_ARITH_UINT256_H
