...
#ifndef OGGNALIVE_UTIL_MESSAGE_H
#define OGGNALIVE_UTIL_MESSAGE_H
 ...
 * @param[in] address Signer's oggnalive address, it must refer to a public key.
...
#endif // OGGNALIVE_UTIL_MESSAGE_H
