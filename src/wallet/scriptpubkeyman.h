...
#ifndef OGGNALIVE_WALLET_SCRIPTPUBKEYMAN_H
#define OGGNALIVE_WALLET_SCRIPTPUBKEYMAN_H
 ...
 * change.
 *
 * The oggnalive Core wallet was originally a collection of unrelated private
...
#endif // OGGNALIVE_WALLET_SCRIPTPUBKEYMAN_H
