...
#ifndef OGGNALIVE_COMPAT_ASSUMPTIONS_H
#define OGGNALIVE_COMPAT_ASSUMPTIONS_H
...
#if defined(NDEBUG)
# error "oggnalive cannot be compiled without assertions."
#endif
...
#endif // OGGNALIVE_COMPAT_ASSUMPTIONS_H
