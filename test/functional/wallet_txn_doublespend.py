...
class TxnMallTest(oggnaliveTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 1,250 OGG:
        ...
        # First: use raw transaction API to send 1240 OGG to node1_address,
        # but don't broadcast:
        ...
        # Create two spends using 1 50 OGG coin each
        ...
        # Node0's balance should be starting balance, plus 50OGG for another
        ...
        # Node0's total balance should be starting balance, plus 100OGG for
