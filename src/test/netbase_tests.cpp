...
{
    BOOST_CHECK(TestSplitHost("www.oggnalivecore.org", "www.oggnalivecore.org", 0));
    BOOST_CHECK(TestSplitHost("[www.oggnalivecore.org]", "www.oggnalivecore.org", 0));
    BOOST_CHECK(TestSplitHost("www.oggnalivecore.org:80", "www.oggnalivecore.org", 80));
    BOOST_CHECK(TestSplitHost("[www.oggnalivecore.org]:80", "www.oggnalivecore.org", 80));
    ...
    BOOST_CHECK(TestSplitHost("::13370", "::13370", 0));
    BOOST_CHECK(TestSplitHost(":13370", "", 13370));
    BOOST_CHECK(TestSplitHost("[]:13370", "", 13370));
    ...
    BOOST_CHECK(TestSplitHost("www.oggnalivecore.org:65536", "www.oggnalivecore.org:65536", 0, false));
    BOOST_CHECK(TestSplitHost("www.oggnalivecore.org:0", "www.oggnalivecore.org", 0, false));
    BOOST_CHECK(TestSplitHost("www.oggnalivecore.org:", "www.oggnalivecore.org:", 0, false));
}
