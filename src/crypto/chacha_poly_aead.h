...
#ifndef OGGNALIVE_CRYPTO_CHACHA_POLY_AEAD_H
#define OGGNALIVE_CRYPTO_CHACHA_POLY_AEAD_H
...
/* A AEAD class for ChaCha20-Poly1305@oggnalive.
 *
 ...
 *
 * The chacha20-poly1305@oggnalive combines these two primitives into an
 ...
 *
 * The chacha20-poly1305@oggnalive cipher requires two 256 bits of key material as
 ...
 * on the send channel.
 *
 * Optimized implementations of ChaCha20-Poly1305@oggnalive are relatively fast in
...
#endif // OGGNALIVE_CRYPTO_CHACHA_POLY_AEAD_H
