...
#ifndef OGGNALIVE_SCRIPT_STANDARD_H
#define OGGNALIVE_SCRIPT_STANDARD_H
 ...
 *  A CTxDestination is the internal data type encoded in a oggnalive address
 */
...
/**
 * Generate a oggnalive scriptPubKey for the given CTxDestination. Returns a P2PKH
...
#endif // OGGNALIVE_SCRIPT_STANDARD_H
