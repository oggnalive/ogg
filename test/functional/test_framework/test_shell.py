...
class TestShell:
    """Wrapper Class for oggnaliveTestFramework.

    The TestShell class extends the oggnaliveTestFramework
    ...
    class __TestShell(oggnaliveTestFramework):
        ...
        def setup(self, **kwargs):
            ...
            # by oggnaliveTestFramework child class.
            self.num_nodes = 1
