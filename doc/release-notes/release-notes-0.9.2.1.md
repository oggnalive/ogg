oggnalive Core version 0.9.2.1 is now available from:

  https://oggnalive.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 OGG to 0.01 OGG
...
- Fix "Start oggnalive on system login"
