...
"""Verify that starting oggnalive with -h works as expected."""

from test_framework.test_framework import oggnaliveTestFramework
from test_framework.util import assert_equal

class HelpTest(oggnaliveTestFramework):
    ...
    def run_test(self):
        self.log.info("Start oggnalive with -h for help text")
        ...
        self.log.info("Start oggnalive with -version for version information")
        ...
        self.log.info("Start oggnalived with -fakearg to make sure it does not start")
