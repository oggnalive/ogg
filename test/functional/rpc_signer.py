...
Verify that a oggnalived node can use an external signer command.
...
class RPCSignerTest(oggnaliveTestFramework):
    ...
    def run_test(self):
        ...
        assert_raises_rpc_error(-1, 'Error: restart oggnalived with -signer=<cmd>',
