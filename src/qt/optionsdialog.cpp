      ...
      ui(new Ui::OptionsDialog)
{
    ...
    ui->oggnaliveAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->oggnaliveAtStartup);
    ...
    ui->oggnaliveAtStartup->setToolTip(ui->oggnaliveAtStartup->toolTip().arg(PACKAGE_NAME));
    ui->oggnaliveAtStartup->setText(ui->oggnaliveAtStartup->text().arg(PACKAGE_NAME));

    ui->openoggnaliveConfButton->setToolTip(ui->openoggnaliveConfButton->toolTip().arg(PACKAGE_NAME));
    ...
    ui->unit->setModel(new oggnaliveUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->oggnaliveAtStartup, OptionsModel::StartAtStartup);
    ...
    mapper->addMapping(ui->m_enable_psbt_controls, OptionsModel::EnablePSOGGontrols);
...
void OptionsDialog::on_openoggnaliveConfButton_clicked()
{
