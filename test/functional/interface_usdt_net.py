...
"""  Tests the net:* tracepoint API interface.
     See https://github.com/oggnalive/oggnalive/blob/master/doc/tracing.md#context-net
"""
...
class NetTracepointTest(oggnaliveTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("connect a P2P test node to our oggnalived node")
