...
#ifndef OGGNALIVE_INTERFACES_NODE_H
#define OGGNALIVE_INTERFACES_NODE_H
...
//! Top-level interface for a oggnalive node (oggnalived process).
class Node
{
public:
    virtual ~Node() {}
    ...
    //! Return setting value from <datadir>/settings.json or oggnalive.conf.
...
#endif // OGGNALIVE_INTERFACES_NODE_H
