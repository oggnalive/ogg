...
#ifndef OGGNALIVE_WALLET_WALLETUTIL_H
#define OGGNALIVE_WALLET_WALLETUTIL_H
...
enum WalletFlags : uint64_t {
    ...
    //! oggnalive from opening the wallet, thinking it was newly created, and
...
#endif // OGGNALIVE_WALLET_WALLETUTIL_H
