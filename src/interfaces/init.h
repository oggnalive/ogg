...
#ifndef OGGNALIVE_INTERFACES_INIT_H
#define OGGNALIVE_INTERFACES_INIT_H
...
//! (oggnalive-gui, oggnalive-node, oggnalive-wallet, oggnalived, oggnalive-qt) and each
...
#endif // OGGNALIVE_INTERFACES_INIT_H
