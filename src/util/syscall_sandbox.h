...
#ifndef OGGNALIVE_UTIL_SYSCALL_SANDBOX_H
#define OGGNALIVE_UTIL_SYSCALL_SANDBOX_H
...
//!
//! SetupSyscallSandbox(...) is called during oggnalived initialization if oggnalive Core was compiled
...
#endif // OGGNALIVE_UTIL_SYSCALL_SANDBOX_H
