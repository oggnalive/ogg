...
def main():
    ...
    g = sys.stdout
    indir = sys.argv[1]
    g.write('#ifndef OGGNALIVE_CHAINPARAMSSEEDS_H\n')
    g.write('#define OGGNALIVE_CHAINPARAMSSEEDS_H\n')
    g.write('/**\n')
    g.write(' * List of fixed seed nodes for the oggnalive network\n')
    ...
    g.write('#endif // OGGNALIVE_CHAINPARAMSSEEDS_H\n')
