...
""" Interactive oggnalived P2P network traffic monitor utilizing USDT and the
    net:inbound_message and net:outbound_message tracepoints. """

# This script demonstrates what USDT for oggnalive Core can enable. It uses BCC
...
def main(oggnalived_path):
    ...
    oggnalived_with_usdts.enable_probe(
