...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the oggnaliveTestFramework
    pass


class ExampleTest(oggnaliveTestFramework):
    # Each functional test is a subclass of the oggnaliveTestFramework class.
    ...
    def custom_method(self):
        ...
        oggnaliveTestFramework class so other tests can use it."""
