...
#ifndef OGGNALIVE_TEST_SCRIPTNUM10_H
#define OGGNALIVE_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from oggnalive Core 0.10.0, for cross-comparison.
 */
public:
...
#endif // OGGNALIVE_TEST_SCRIPTNUM10_H
