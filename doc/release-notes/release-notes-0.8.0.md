oggnalive-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/oggnalive/files/oggnalive/oggnalive-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the oggnalive
...
New/changed settings (command-line or oggnalive.conf file)
--------------------------------------------------------
