...
class TransactionTimeRescanTest(oggnaliveTestFramework):
    ...
    def run_test(self):
        ...
        minernode = self.nodes[0]  # node used to mine OGG and create transactions
        ...
        # generate some ogg to create transactions and check blockcount
        ...
        # send 10 ogg to user's first watch-only address
        self.log.info('Send 10 ogg to user')
        ...
        # send 5 ogg to our second watch-only address
        self.log.info('Send 5 ogg to user')
        ...
        # send 1 ogg to our third watch-only address
        self.log.info('Send 1 ogg to user')
