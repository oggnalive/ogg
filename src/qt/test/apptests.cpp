...
//! Entry point for oggnaliveApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &oggnaliveApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for oggnaliveGUI tests.
void AppTests::guiTests(oggnaliveGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &oggnaliveGUI::consoleShown, this, &AppTests::consoleTests);
