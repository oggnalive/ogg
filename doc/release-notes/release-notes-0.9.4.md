oggnalive Core version 0.9.4 is now available from:

  https://oggnalive.org/bin/0.9.4/
...
this update is incompatible with the oggnalive system and could lead to consensus
forks.

oggnalive Core released binaries from https://oggnalive.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~oggnalive/+archive/ubuntu/oggnalive
- A third-party or self-compiled oggnalive Core

upgrade to oggnalive Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
