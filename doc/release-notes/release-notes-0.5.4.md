oggnalive version 0.5.4 is now available for download at:
http://sourceforge.net/projects/oggnalive/files/oggnalive/oggnalive-0.5.4/
...
http://gitorious.org/oggnalive/oggnalived-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix oggnalive-Qt notifications under Growl 1.3.
Increase required age of oggnalive-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxoggnalive properly when installing oggnalive-Qt over it. (Windows)
