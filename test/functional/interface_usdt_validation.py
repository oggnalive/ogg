...
""" Tests the validation:* tracepoint API interface.
    See https://github.com/oggnalive/oggnalive/blob/master/doc/tracing.md#context-validation
"""
...
class ValidationTracepointTest(oggnaliveTestFramework):
    ...
    def run_test(self):
        ...
        # blocks.
        # See https://github.com/oggnalive/oggnalive/blob/master/doc/tracing.md#tracepoint-validationblock_connected
