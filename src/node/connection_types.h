...
#ifndef OGGNALIVE_NODE_CONNECTION_TYPES_H
#define OGGNALIVE_NODE_CONNECTION_TYPES_H
 ...
 * src/qt/guiutil.cpp and src/oggnalive-cli.cpp::NetinfoRequestHandler. */
enum class ConnectionType {
     ...
     * Note that in the literature ("Eclipse Attacks on oggnalive’s Peer-to-Peer Network")
...
#endif // OGGNALIVE_NODE_CONNECTION_TYPES_H
