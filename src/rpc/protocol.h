...
#ifndef OGGNALIVE_RPC_PROTOCOL_H
#define OGGNALIVE_RPC_PROTOCOL_H
...
enum RPCErrorCode
{
    ...
    // RPC_INTERNAL_ERROR should only be used for genuine errors in oggnalived
    ...
    //! P2P client errors
    RPC_CLIENT_NOT_CONNECTED        = -9,  //!< oggnalive is not connected
...
#endif // OGGNALIVE_RPC_PROTOCOL_H
